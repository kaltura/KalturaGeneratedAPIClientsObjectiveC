...
@synthesize enforceDelivery = _enforceDelivery;
...
@synthesize apiAccessControlId = _apiAccessControlId;
@synthesize defaultDeliveryType = _defaultDeliveryType;
@synthesize defaultEmbedCodeType = _defaultEmbedCodeType;
@synthesize customDeliveryTypes = _customDeliveryTypes;
@synthesize restrictEntryByMetadata = _restrictEntryByMetadata;
...
- (id)init
{
    ...
    self->_enforceDelivery = KALTURA_UNDEF_BOOL;
...
{
    self.enforceDelivery = [KalturaSimpleTypeParser parseBool:aPropVal];
}
...
{
    self.apiAccessControlId = [KalturaSimpleTypeParser parseInt:aPropVal];
}
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    ...
    [aParams addIfDefinedKey:@"enforceDelivery" withBool:self.enforceDelivery];
    ...
    [aParams addIfDefinedKey:@"apiAccessControlId" withInt:self.apiAccessControlId];
    [aParams addIfDefinedKey:@"defaultDeliveryType" withString:self.defaultDeliveryType];
    [aParams addIfDefinedKey:@"defaultEmbedCodeType" withString:self.defaultEmbedCodeType];
    [aParams addIfDefinedKey:@"customDeliveryTypes" withArray:self.customDeliveryTypes];
    [aParams addIfDefinedKey:@"restrictEntryByMetadata" withBool:self.restrictEntryByMetadata];
...
- (void)dealloc
{
    ...
    [self->_customDeliveryTypes release];
    [self->_language release];
    [self->_audioThumbEntryId release];
    [self->_liveThumbEntryId release];
    [super dealloc];
}
...
{
    return [self.client queueArrayService:@"systempartner_systempartner" withAction:@"getPlayerEmbedCodeTypes" withExpectedType:@"KalturaPlayerEmbedCodeType"];
}

- (NSMutableArray*)getPlayerDeliveryTypes
{
    return [self.client queueArrayService:@"systempartner_systempartner" withAction:@"getPlayerDeliveryTypes" withExpectedType:@"KalturaPlayerDeliveryType"];
}
