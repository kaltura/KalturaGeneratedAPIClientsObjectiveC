...
// @ignore
// ===================================================================================================
#import "KalturaScheduleDropFolderClientPlugin.h"

///////////////////////// enums /////////////////////////
///////////////////////// classes /////////////////////////
@implementation KalturaDropFolderICalBulkUploadFileHandlerConfig
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    ...
    if (!aIsSuper)
        [aParams putKey:@"objectType" withString:@"KalturaDropFolderICalBulkUploadFileHandlerConfig"];
