...
///////////////////////// classes /////////////////////////
@implementation KalturaDrmLicenseAccessDetails
@synthesize policy = _policy;
@synthesize duration = _duration;
@synthesize absolute_duration = _absolute_duration;
@synthesize licenseParams = _licenseParams;
...
- (id)init
{
    ...
    self->_absolute_duration = KALTURA_UNDEF_INT;
    return self;
}
...
{
    self.absolute_duration = [KalturaSimpleTypeParser parseInt:aPropVal];
}
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    ...
    if (!aIsSuper)
        [aParams putKey:@"objectType" withString:@"KalturaDrmLicenseAccessDetails"];
    [aParams addIfDefinedKey:@"policy" withString:self.policy];
    [aParams addIfDefinedKey:@"duration" withInt:self.duration];
    [aParams addIfDefinedKey:@"absolute_duration" withInt:self.absolute_duration];
    [aParams addIfDefinedKey:@"licenseParams" withArray:self.licenseParams];
}

- (void)dealloc
{
    [self->_policy release];
    [self->_licenseParams release];
    [super dealloc];
}
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    ...
    [aParams addIfDefinedKey:@"signingKey" withString:self.signingKey];
}
...
- (void)dealloc
{
    ...
    [self->_signingKey release];
    [super dealloc];
}

@end

@implementation KalturaAccessControlDrmPolicyAction
...
- (void)toParams:(KalturaParams*)aParams isSuper:(BOOL)aIsSuper
{
    [super toParams:aParams isSuper:YES];
    if (!aIsSuper)
        [aParams putKey:@"objectType" withString:@"KalturaAccessControlDrmPolicyAction"];
...
@implementation KalturaDrmLicenseAccessService
- (KalturaDrmLicenseAccessDetails*)getAccessWithEntryId:(NSString*)aEntryId withFlavorIds:(NSString*)aFlavorIds withReferrer:(NSString*)aReferrer
{
    ...
    [self.client.params addIfDefinedKey:@"flavorIds" withString:aFlavorIds];
    [self.client.params addIfDefinedKey:@"referrer" withString:aReferrer];
    return [self.client queueObjectService:@"drm_drmlicenseaccess" withAction:@"getAccess" withExpectedType:@"KalturaDrmLicenseAccessDetails"];
}
...
- (KalturaDrmLicenseAccessService*)drmLicenseAccess
{
    if (self->_drmLicenseAccess == nil)
    	self->_drmLicenseAccess = [[KalturaDrmLicenseAccessService alloc] initWithClient:self.client];
    return self->_drmLicenseAccess;
}
...
- (void)dealloc
{
    ...
    [self->_drmLicenseAccess release];
	[super dealloc];
}
